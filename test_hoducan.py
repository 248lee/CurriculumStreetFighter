...
from street_fighter_custom_wrapper import StreetFighterCustomWrapper, HoducanStreetFighterCustomWrapper

RESET_ROUND = True  # Whether to reset the round when fight is over. 
RENDERING = True    # Whether to render the game screen.

MODEL_NAME = r"ppo_chun_vs_ryu_john_punishment_s2_final" # Specify the model file to load. Model "ppo_ryu_2500000_steps_updated" is capable of beating the final stage (Bison) of the game.
...
def make_env(game, state):
    def _init():
        ...
        env = HoducanStreetFighterCustomWrapper(env, reset_round=RESET_ROUND, rendering=RENDERING, load_state_name='Champion.Level12.RyuVsHonda_4.state')
        return env
    return _init
