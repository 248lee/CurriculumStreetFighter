...
MODEL_NAME = r"ppo_ryu_vs_sagat_s2_lambd_by_return_10000000_steps" # Specify the model file to load. Model "ppo_ryu_2500000_steps_updated" is capable of beating the final stage (Bison) of the game.
...
def make_env(game, state):
    def _init():
        ...
        env = StreetFighterCustomWrapper(env, reset_round=RESET_ROUND, rendering=RENDERING, load_state_name='Champion_RyuVSSagat_D5_13.state')
        return env
    return _init
